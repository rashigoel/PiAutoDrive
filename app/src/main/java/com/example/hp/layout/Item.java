...
/**
 * Created by Rashi on 14-07-2016.
 */
public class Item {
     ...
     */
    public static ArrayList<Item> getTestingList(Context c) {
        ArrayList<Item> items = new ArrayList<>();
        items.add(new Item("$14", "$270", "W 79th St, NY, 10024", "W 139th St, NY, 10030", 3, "TODAY", "05:10 PM"));
        //items.add(new Item("$14", "$270", "W 79th St, NY, 10024", "W 139th St, NY, 10030", 3, "TODAY", "05:10 PM",new MapView(c)));
